...
function [decisions,result_labels] = rf_train()
    ...
    for k=1:iterations
        ...
        classifier = TreeBagger(Ntrees, Xtrain,Ytrain,'Method','classification');
